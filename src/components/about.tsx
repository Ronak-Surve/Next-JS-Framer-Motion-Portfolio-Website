        ...
        <div className="grid xl:grid-cols-2 lg:text-start">
          ...
          <div className="flex-1">
            ...
            <div className="text-lg mt-12 xl:mt-3">
              ...
              <Fade direction="up" delay={400} cascade damping={1e-1} triggerOnce={true}>
                <h3 className="font-bold mt-6 text-xl"> Who am I? </h3>
              </Fade>
              <Fade direction="up" delay={600} cascade damping={1e-1} triggerOnce={true}>
                <p className="mt-2 leading-relaxed text-md text-gray-700 dark:text-white/70">
                Hi, I’m Ronak, a passionate web developer dedicated to crafting seamless, dynamic, and highly responsive websites. With a strong command of HTML, CSS, JavaScript, React, and Next.js, I focus on building websites that are scalable and optimized.
                </p>
              </Fade>
