  ...
  return (
    ...
    >
      ...
      <h1 className="mb-10 mt-4 px-4 text-2xl sm:text-4xl">
        <span className="font-medium !leading-[1.5] "> Hi, I am Ronak</span>{" "}
      ...
      >
        <Link
          href="mailto:ronaksurve344rs@gmail.com"
          className="group bg-gray-900 text-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 hover:bg-gray-950 dark:bg-white/10 active:scale-105 transition"
          onClick={() => {
            location.href='ronaksurve344rs@gmail.com';
        ...
        <a
          ...
          href="https://www.linkedin.com/in/ronak-surve-5793341a8/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/Ronak-Surve"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
